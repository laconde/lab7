...
// In getPrices you pass it by reference because a copy of the address of the actual parameter is stored. You want to be able to change it. On the other hand, printPrices you are making a copy in memory of the actual parameter's value (passing by value), because you're not changing it for the client program.
